"""
Django settings for NotesSnipt project.
...
SECRET_KEY = 'django-insecure-5#%02a*)fi*@38ahssrgm-c!(x2z#k8@i)cw2woi+vu(3ky9uf'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Har API ko authenticated user hi access karega
    ]
}
...
WSGI_APPLICATION = 'NotesSnipt.wsgi.application'
